...
class ConsentTemplateService {
    ...
    static generateConsentText(type, data) {
    ...
    static generatePDF(consentText) {
...
ConsentTemplateService.templates = new Map([
    ['surgery', {
            type: 'surgery',
...
//# sourceMappingURL=ConsentTemplateService.js.map