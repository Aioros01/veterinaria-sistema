    ...
    static middleware() {
        return (req, res, next) => {
            ...
            res.json = function (data) {
                ...
                if (req.timings && req.timings.length > 0) {
                    console.log(`\n📈 Timing Breakdown:`);
                    let lastTime = 0;
                    req.timings.forEach((timing, index) => {
...
function measureAsync(operation, fn, requestId) {
