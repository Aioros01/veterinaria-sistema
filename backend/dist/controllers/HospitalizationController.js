...
exports.HospitalizationController = void 0;
...
class HospitalizationController {
    constructor() {
        this.hospitalizationRepo = database_1.AppDataSource.getRepository(Hospitalization_1.Hospitalization);
        this.medicationRepo = database_1.AppDataSource.getRepository(HospitalizationMedication_1.HospitalizationMedication);
        this.noteRepo = database_1.AppDataSource.getRepository(HospitalizationNote_1.HospitalizationNote);
    }
    ...
    async addMedication(req, res) {
        try {
            ...
            if (!hospitalization) {
                throw new errorHandler_1.AppError(404, 'Hospitalización no encontrada');
            }
    ...
    async administerMedication(req, res) {
        try {
            ...
            if (!medication) {
                throw new errorHandler_1.AppError(404, 'Medicamento no encontrado');
            }
        ...
        try {
            ...
            if (req.user.role === 'client') {
                ...
                if (pet.ownerId !== req.user.id) {
                    throw new errorHandler_1.AppError(403, 'No tienes permiso para ver esta hospitalización');
                }
            }
    ...
    async getByPet(req, res) {
        try {
            ...
            if (req.user.role === 'client' && pet.ownerId !== req.user.id) {
                throw new errorHandler_1.AppError(403, 'No tienes permiso para ver las hospitalizaciones de esta mascota');
            }
...
exports.HospitalizationController = HospitalizationController;
//# sourceMappingURL=HospitalizationController.js.map